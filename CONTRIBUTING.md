Contributing to MYCE Core
============================

The MYCE Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MYCE Core project, and is not to be
confused with overall MYCE Network Protocol consensus changes.

Whether a pull request is merged into MYCE Core rests with the project merge
...
The project leader is the release manager for each MYCE Core release.
