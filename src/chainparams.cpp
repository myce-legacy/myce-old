...
public:
    CMainParams()
    {
        ...
        nBlockZerocoinV2 = nZerocoinStartHeight + 10; //!> The block that zerocoin v2 becomes active - roughly Tuesday, May 8, 2018 4:00:00 AM GMT
        ...
        vSeeds.push_back(CDNSSeedData("0", "45.77.189.236"));
        vSeeds.push_back(CDNSSeedData("1", "212.237.38.113"));
        vSeeds.push_back(CDNSSeedData("2", "80.211.186.87"));
        vSeeds.push_back(CDNSSeedData("3", "80.211.186.127"));
        vSeeds.push_back(CDNSSeedData("4", "80.211.168.199"));
        vSeeds.push_back(CDNSSeedData("5", "88.99.54.189"));
        vSeeds.push_back(CDNSSeedData("6", "zentec.ddns.net"));
