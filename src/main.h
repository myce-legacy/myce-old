...
static const unsigned int DEFAULT_BLOCK_MAX_SIZE = 7500000; // 75% of current max
static const unsigned int DEFAULT_BLOCK_MIN_SIZE = 0;
/** Default for -blockmaxcost, which control the range of block costs the mining code will create **/
static const unsigned int DEFAULT_BLOCK_MAX_COST = 3*MAX_BLOCK_SIZE_CURRENT; // 75% of current max
/** Default for -blockprioritysize, maximum space for zero/low-fee transactions **/
static const unsigned int DEFAULT_BLOCK_PRIORITY_SIZE = 50000;
/** Default for accepting alerts from the P2P network. */
static const bool DEFAULT_ALERTS = true;
/** The maximum size for transactions we're willing to relay/mine */
static const unsigned int MAX_STANDARD_TX_COST = 1200000;
/** The maximum allowed number of signature check operations in a block (network rule) */
static const unsigned int MAX_BLOCK_SIGOPS_COST = 100000;
...
static const unsigned int MAX_BLOCK_SERIALIZED_SIZE = 4*MAX_BLOCK_SIZE_CURRENT;
/** The maximum allowed cost for a block, see BIP 141 (network rule) */
static const int64_t MAX_BLOCK_COST = 4*MAX_BLOCK_SIZE_CURRENT;
/** The maximum allowed size for a block excluding witness data, in bytes (network rule) */
static const unsigned int MAX_BLOCK_BASE_SIZE = MAX_BLOCK_SIZE_CURRENT;
