...
/* Myce GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MYCE"
#define QAPP_ORG_DOMAIN "myce.org"
#define QAPP_APP_NAME_DEFAULT "MYCE-Qt"
#define QAPP_APP_NAME_TESTNET "MYCE-Qt-testnet"
