                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzYCEPathCustom = GetArg("-zycebackuppath", "");
    ...
    if(!strzYCEPathCustom.empty()) {
        ui->wallet_customzycebackuppath->setText(QString::fromStdString(strzYCEPathCustom));
        ui->wallet_customzycebackuppath_label->setVisible(true);
        ui->wallet_customzycebackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzYCEPathCustom.empty()) && nCustomBackupThreshold > 0) {
