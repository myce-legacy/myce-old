...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Myce"), this);
    aboutAction->setStatusTip(tr("Show information about Myce"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Myce help message to get a list with possible Myce command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Myce client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Myce"); // default title
