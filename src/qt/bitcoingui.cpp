                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    this->setStyleSheet(GUIUtil::loadStyleSheet());
      this->setFixedSize(QSize(740, 418));
      this->setWindowFlags(windowFlags() ^ Qt::WindowMaximizeButtonHint);

      GUIUtil::restoreWindowGeometry("nWindow", QSize(850, 550), this);

    QString windowTitle = tr("MYCE Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zYCE"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MYCE Core"), this);
    aboutAction->setStatusTip(tr("Show information about MYCE Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MYCE"));
    ...
    openAction->setStatusTip(tr("Open a MYCE: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MYCE Core help message to get a list with possible MYCE command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MYCE Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("MYCE Core"); // default title
